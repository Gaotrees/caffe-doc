...
Go to the https://github.com/BVLC/caffe and download the zip archive. Unpack it to ~/bin/ or any other location. Enter the caffe-master directory in the terminal window. Note that only the version 1.0RC5 compiles well at this moment, so download https://github.com/BVLC/caffe/archive/rc5.zip. If you download 1.0 version, you need to edit the file /src/caffe/util/blocking_queue.cpp. After the line 89, add the new line that contains the following: 
```
